...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in park_pb2_grpc.py depends on'
...
class CarParkServiceStub(object):
...
def add_CarParkServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
